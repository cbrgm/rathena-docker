...
sed -i "7s|FluxRO|${SERVER_NAME}|" /var/www/fluxcp/config/servers.php
...
echo "Configure application.php..."
sed -i "5s|localhost|${SERVER_ADDRESS}|" /var/www/fluxcp/config/application.php
sed -i "6s|fluxcp|${SERVER_BASE_DIR}|" /var/www/fluxcp/config/application.php
